...
{
  typedef void (*GMarshalFunc_VOID__UCHAR_POINTER) (gpointer     data1,
                                                    guchar       arg_1,
                                                    gpointer     arg_2,
                                                    gpointer     data2);
  register GMarshalFunc_VOID__UCHAR_POINTER callback;
  ...
  callback = (GMarshalFunc_VOID__UCHAR_POINTER) (marshal_data ? marshal_data : cc->callback);
...
g_cclosure_user_marshal_VOID__INT_LONG (GClosure     *closure,
                                        ...
                                        gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__INT_LONG) (gpointer     data1,
                                               gint         arg_1,
                                               glong        arg_2,
                                               gpointer     data2);
  register GMarshalFunc_VOID__INT_LONG callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__INT_LONG) (marshal_data ? marshal_data : cc->callback);
