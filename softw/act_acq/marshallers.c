...
g_cclosure_user_marshal_VOID__ULONG_STRING (GClosure     *closure,
                                            ...
                                            gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__ULONG_STRING) (gpointer     data1,
                                                   gulong       arg_1,
                                                   gpointer     arg_2,
                                                   gpointer     data2);
  register GMarshalFunc_VOID__ULONG_STRING callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__ULONG_STRING) (marshal_data ? marshal_data : cc->callback);
